...
const Foam::volScalarField& Foam::basicThermo::Te() const
{
    return Te_;
}

Foam::volScalarField& Foam::basicThermo::Te() 
{
    return Te_;
}

const Foam::volScalarField& Foam::basicThermo::Tion() const
{
    return Tion_;
}

Foam::volScalarField& Foam::basicThermo::Tion() 
{
    return Tion_;
}
