...
namespace Foam
{
    ...
    makeChemistrySolverType(EulerImplicit, psiChemistryModel, constGasThermoPhysics)
    makeChemistrySolverType(ode, psiChemistryModel, constGasThermoPhysics)
    makeChemistrySolverType(sequential, psiChemistryModel, constGasThermoPhysics)
