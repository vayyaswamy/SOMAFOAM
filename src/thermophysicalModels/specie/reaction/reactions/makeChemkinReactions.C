...
#include "ModifiedArrheniusReactionRate.H"
...
makeIRNReactions(constGasThermoPhysics, ModifiedArrheniusReactionRate)
...
makeIRNReactions(gasThermoPhysics, ModifiedArrheniusReactionRate)
