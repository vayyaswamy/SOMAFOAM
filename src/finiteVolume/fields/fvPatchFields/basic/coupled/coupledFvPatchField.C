...
{
    //Info << "coupled valueInternalCoeffs" << endl;
...
{
    //Info << "coupled valueBoundaryCoeffs" << endl;
...
{
    //Info << "coupled gradientInternalCoeffs" << endl;
...
{
    //Info << "coupled gradientBoundaryCoeffs" << endl;
