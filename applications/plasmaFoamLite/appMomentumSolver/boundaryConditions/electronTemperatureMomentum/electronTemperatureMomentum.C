...
#include "electronTemperatureMomentum.H"
...
Foam::electronTemperatureMomentum::electronTemperatureMomentum
(
    const fvPatch& p,
...
Foam::electronTemperatureMomentum::electronTemperatureMomentum
(
    const electronTemperatureMomentum& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::electronTemperatureMomentum::updateCoeffs()
{
    if (this->updated())
    {
        return;
    ...
    //Info << "electronTemperatureMomentum updateCoeffs " << endl;
   ...
   // Info << "Step 1" << endl ;
    ...
    const scalarField C2 = 0*kappaef;

    const scalarField C3 = 0*seec_*(Fifnorm)*1.38e-23*Tse_;
...
void Foam::electronTemperatureMomentum::write(Ostream& os) const
{
...
void Foam::electronTemperatureMomentum::operator=
(
