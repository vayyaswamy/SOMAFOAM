...
void Foam::driftDiffusionElectronDensity::updateCoeffs()
{
    ...
    forAll(temp1, facei)
    {
        //Info << "Ef_bound[facei]:" << Ef_bound[facei] << " Ef[facei]:" << Ef[facei] << " Ef[faceCelli]:" << Ef[faceCelli] << endl;
        //Info << " TEf[facei]:" << Tef[facei] << " TEf[faceCelli]:" << Tef[faceCelli] << endl;
        //Info << " Def[facei]:" << Def[facei] << " Def[faceCelli]:" << Def[faceCelli] << endl;
        label faceCelli = patch().faceCells()[facei];
        int a = 0*pos(Ef[facei]&n[facei]);
        ...
        temp2[facei]=a*seec_*(Fif[facei]&n[facei])*this->patch().deltaCoeffs()[facei];
